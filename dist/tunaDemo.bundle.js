...
},{"./tunaUi.mustache":7,"jquery":2}],7:[function(require,module,exports){
var t = new (require('hogan.js/lib/template')).Template(function(c,p,i){var _=this;_.b(i=i||"");if(_.s(_.f("groups",c,p,1),c,p,0,11,307,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("<div  class=\"group\">\r");_.b("\n" + i);_.b("\r");_.b("\n" + i);if(_.s(_.f("parameters",c,p,1),c,p,0,52,280,"{{ }}")){_.rs(c,p,function(c,p,_){_.b("<label>\r");_.b("\n" + i);_.b("<div class=\"name\">");_.b(_.v(_.f("name",c,p,0)));_.b("</div>\r");_.b("\n" + i);_.b("<div class=\"value\"><input type=\"");_.b(_.v(_.f("controlType",c,p,0)));_.b("\" data-name=\"");_.b(_.v(_.f("name",c,p,0)));_.b("\" data-type=\"");_.b(_.v(_.f("type",c,p,0)));_.b("\" min=\"");_.b(_.v(_.f("min",c,p,0)));_.b("\" max=\"");_.b(_.v(_.f("max",c,p,0)));_.b("\" value=\"");_.b(_.v(_.f("value",c,p,0)));_.b("\" step=\"");_.b(_.v(_.f("step",c,p,0)));_.b("\" ");_.b(_.v(_.f("orient",c,p,0)));_.b(" ></div>\r");_.b("\n" + i);_.b("</label>\r");_.b("\n");});c.pop();}_.b("\r");_.b("\n" + i);_.b("</div>\r");_.b("\n");});c.pop();}return _.fl();;});module.exports = {  render: function () { return t.render.apply(t, arguments); },  r: function () { return t.r.apply(t, arguments); },  ri: function () { return t.ri.apply(t, arguments); }};
...
},{"./sources/graphicEqualizer":3,"./sources/panner":4,"./sources/stereoSpread-delay":5,"./sources/tunaUi":6,"jquery":2}]},{},[8]);
