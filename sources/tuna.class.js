...
var userContext;
var userInstance;
var FLOAT = "float" BOOLEAN = "boolean", STRING = "string", INT = "int";

var pipe = function(param, val) {
param.value = val;
}; // pipe
...
if (this.activateCallback) {this.activateCallback(true);}

} else {
this.input.disconnect();
this.input.connect(this.output);
if (this.activateCallback) {this.activateCallback(false);}
} // if
} // activate
...
automate (property, value, duration, startTime) {
var start = startTime ? ~~(startTime / 1000) : userContext.currentTime;
var dur = duration ? ~~(duration / 1000) : 0;
...
_context = window.AudioContext && (new window.AudioContext());
} // if
